...
public class AircraftSectionList extends ArrayList<AircraftSection> {
	...
	public void createSections(char aircraftSize_, int seatsFilledPerSection_[], BigDecimal costOfSeat_) {
		...
		case 's':
			...
			add(new AircraftSection(seatsFilledPerSection_[0], _classSectionName, costOfSeat_));
			break;
		case 'm':
			...
			add(new AircraftSection(seatsFilledPerSection_[2], _classSectionName, costOfSeat_));
			_classSectionName = sectionClassTypes.FIRST.toString();
			add(new AircraftSection(seatsFilledPerSection_[3], _classSectionName, costOfSeat_));
			break;
		case 'l':
		default:
			...
			add(new AircraftSection(seatsFilledPerSection_[1], _classSectionName, costOfSeat_));
			_classSectionName = sectionClassTypes.BUSINESS.toString();
			add(new AircraftSection(seatsFilledPerSection_[2], _classSectionName, costOfSeat_));
			_classSectionName = sectionClassTypes.FIRST.toString();
			add(new AircraftSection(seatsFilledPerSection_[3], _classSectionName, costOfSeat_));
